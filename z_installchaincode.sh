...
#docker exec -e "CORE_PEER_ADDRESS=admin.license.com:7051" admin.license.com peer chaincode install -n proofit -v beta0 -l node -p /etc/hyperledger/chaincode/proofit
...
#docker exec -e "CORE_PEER_ADDRESS=qnet.license.com:7051" admin.license.com peer chaincode install -n proofit -v beta0 -l node -p /etc/hyperledger/chaincode/proofit
...
#docker exec -e "CORE_PEER_ADDRESS=admin.language.com:7051" admin.language.com peer chaincode install -n proofit -v beta0 -l node -p /etc/hyperledger/chaincode/proofit
...
#docker exec -e "CORE_PEER_ADDRESS=toeic.language.com:7051" admin.language.com peer chaincode install -n proofit -v beta0 -l node -p /etc/hyperledger/chaincode/proofit
