...
docker exec admin.app.com peer channel update -o orderer.ca.com:7050 -c account -f appAnchorPeerProofit.tx #--certfile PATH --cafile PATH --tls
...
docker exec admin.recruit.com peer channel update -o orderer.ca.com:7050 -c account -f recruitAnchorPeerRecruit.tx #--certfile PATH --cafile PATH --tls
...
docker exec admin.univ.com peer channel update -o orderer.ca.com:7050 -c account -f univAnchorPeerProofit.tx #--certfile PATH --cafile PATH --tls
...
#docker exec admin.license.com peer channel update -o orderer.ca.com:7050 -c account -f licenseAnchorPeerProofit.tx #--certfile PATH --cafile PATH --tls
...
#docker exec admin.language.com peer channel update -o orderer.ca.com:7050 -c account -f languageAnchorPeerProofit.tx #--certfile PATH --cafile PATH --tls
